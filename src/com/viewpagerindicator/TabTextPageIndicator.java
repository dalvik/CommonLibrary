 ...
 */
public class TabTextPageIndicator extends HorizontalScrollView implements PageIndicator {
    /**
    ...
    private void addTab(int index, CharSequence text, int layoutID, boolean showLine) {
        final TabView tabView = new TabView(getContext());
        tabView.mIndex = index;
        tabView.setOnClickListener(mTabClickListener);
        View view = LayoutInflater.from(getContext()).inflate(R.layout.lib_layout_viewpagerindicator_pager_title, null);
        TextView tv = (TextView) view.findViewById(R.id.lib_id_viewpagerindicator_pager_title);
        tv.setText(text);
        // 设置字体加粗
        // tv.getPaint().setFakeBoldText(true);
        setTextColor(tv);
        ImageView newsIv = (ImageView) view.findViewById(R.id.lib_id_viewpagerindicator_pager_news);
        if (getNewsCirle(index)) {
            newsIv.setVisibility(View.VISIBLE);
        }
        ImageView line = (ImageView) view.findViewById(R.id.lib_id_viewpagerindicator_pager_line);
        if (!showLine) {
