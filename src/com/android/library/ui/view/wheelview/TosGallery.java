 ...
 * <p/>
 * Views given to the Gallery should use {@link LayoutParams} as
...
public class TosGallery extends TosAbsSpinner implements GestureDetector.OnGestureListener,
    ...
    public void scrollIntoSlots() {
        ...
        if (0 == mFirstPosition) {
            ...
            if (child.getLeft() >= 0) {
				 ...
				 *
				 * // Add this line to solve the issue that shrink children.
				 * scrollAmount = getPaddingLeft() - m_firstChildOffset;
				 */
     ...
     * @param child   The view to position
     * @param offset  Offset from the selected position
     * @param y       X-coordintate indicating where this view should be placed.
     *                This will either be the left or right edge of the view,
     *                depending on the fromLeft paramter
     ...
     *
     * @param disableScroll true if disable the scroll action, otherwise false, default
     *                      false.
     * @author LeeHong
     */
