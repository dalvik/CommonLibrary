...
public class ShortcutUtil {
    ...
    /**
     * @param act          ： 当前的activity , not null
     * @param iconResId    : shortcut 的 ICON , not null
     * @param shortcutName ： , not null
     * @param cls          ： 启动主入口 , not null
     * @param intent       : 需要传参数的时候，可以传 null
     */
    public static void createShortCut(Context appContext, int iconResId, String shortcutName, Class<?> cls,
                                      Intent intent) {
    ...
    public static boolean hasShortcut(Context appContext, String shortcutName) {
        ...
        Cursor c = cr.query(CONTENT_URI, PROJECTION, "title=?", new String[]{shortcutName}, null);
