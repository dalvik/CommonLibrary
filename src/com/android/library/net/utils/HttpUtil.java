...
public final class HttpUtil {
     ...
     * @param parser
     */
    public static <T> T loadPostRequest(String url, byte[] params, InputStreamParser<T> parser) {
        return loadData(true, url, null, params, parser);
    }

    public static <T> T loadPostRequest(String url, HashMap<String, String> headers, byte[] params, InputStreamParser<T> parser) {
     ...
     * @param parser
     */
    public static <T> T loadData(boolean isPost, String url, HashMap<String, String> headers, byte[] params, InputStreamParser<T> parser) {
