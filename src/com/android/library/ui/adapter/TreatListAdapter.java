...
public class TreatListAdapter extends BaseListAdapter<Object> {

    public TreatListAdapter(BaseCommonActivity activity) {
        super(activity);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(activity).inflate(R.layout.treat_list_item, null);
            holder = new Holder();
